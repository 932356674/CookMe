...
public class GetMessageCode {
    ...
    private static final String ACCOUNT_SID = "717353cd41ef4f52ad40a300e5e2875f";
    private static final String AUTH_TOKEN = "3e0a692500fa4d8293809e0d526e9aa0";
    ...
    public static String getCode(String phone) {
        ...
        String tamp = "【果蔬叔科技】您的验证码为："+rod+"，如非本人操作，请忽略此短信。";
